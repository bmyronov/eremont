from repairshop.models import ContactInformation, HomeContent, OrderStatus, SubCategory
...
def main():
    ...
    HomeContent.objects.update_or_create(
        ...
        card_one_description="lorem",
        card_one_link="about",
        card_two_title="Якiсть",
        card_two_description="lorem",
        card_two_link="about",
        card_three_title="Доступна цiна",
        card_three_description="lorem",
