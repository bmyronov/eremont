"""
Django settings for eremont project.
...
WSGI_APPLICATION = "eremont.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "USER": config.DB_USER,  # postgres username
        "PASSWORD": config.DB_PASSWORD,  # password
        "HOST": config.DB_HOST,  # postgres host (localhost by default)
